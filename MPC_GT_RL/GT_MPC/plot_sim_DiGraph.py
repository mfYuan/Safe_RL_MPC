...
def plot_sim(X_old, params, step, Level_ratio, fig, counter):
    ...
    for id in range(0, len(X_old[0,:])):
        if id ==0:
            ax.annotate('car 1', xy=(X_old[0, id], X_old[1, id]-0.5))
        elif id ==1:
            ax.annotate('Ego', xy=(X_old[0, id], X_old[1, id]-0.5))
        elif id ==2:
            ax.annotate('car 2', xy=(X_old[0, id], X_old[1, id]-0.5))
        elif id ==3:
            ax.annotate('car 3', xy=(X_old[0, id], X_old[1, id]-0.5))
    ...
    plt.savefig('/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/safe_RL/MPC_RL/Images/'+str(counter)+'.png', dpi = 100, bbox_inches='tight', pad_inches=0.5)
    plt.pause(0.001)
    plt.clf()
