...
def DecisionTree_L1(X_pseudo, car_id, action_space, params, Level_ratio, L_matrix_all):
            ...
            for dist_id_1 in range(0, len(dist_comb)):
                ...
                for id_2 in range(0, action_space.size):
                    ...
                    for dist_id_2 in range(0, len(dist_comb)):
                        k = 1
                        X_old1 = Buffer[k]
                        X_new, R2 = environment_DiGraph.environment(X_old1, car_id, id_2, t_step_DT, params, dist_id_2,
                                                            Level_ratio, L_matrix_all)
